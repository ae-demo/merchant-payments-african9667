...
test("AC-015-b: a Platform Admin can approve a pending merchant submission", async ({ page, request, browser }) => {
  ...
  // 2. Sign in as admin, open the submission, and approve it
  await uiSignIn(
    page,
    target("admin-webapp"),
  ...
  // 3. Assert the merchant's status became approved
