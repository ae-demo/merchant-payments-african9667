...
export const mockRoles: readonly { readonly name: string; readonly grants: readonly string[] }[] = [
  { name: "Merchant", grants: ["merchants:read", "merchants:update", "payment-links:create", "payment-links:read", "payouts:read", "payouts:request", "transactions:read"] },
  { name: "PlatformAdmin", grants: ["disputes:read-all", "disputes:resolve", "merchants:read-all", "merchants:review", "merchants:suspend", "transactions:read-all"] },
];
